          ...
          <div className="relative z-10 max-w-lg mx-auto">
            ...
            <div className="md:flex mb-16">
              ...
              <div className="max-w-xs">
                <p className="text-lg font-semibold text-gray-400">Get the latest Tech news, insights, free courses and book</p>
              </div>
            </div>
            <div className="sm:flex items-center">
              <input name="email" onChange={(e) => setEmail(e.target.value)} className="w-full mb-3 sm:mb-0 sm:mr-4 py-3 px-4 text-sm text-gray-900 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="email" placeholder="pat@saturn.dev" />
              <button className="relative group inline-block flex-shrink-0 w-full sm:w-auto py-3 px-5 text-sm font-semibold text-orange-50 bg-gray-900 rounded-md overflow-hidden" type="submit">
